...
public class AuthTokenFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		JwtAuthenticationToken oauthJwtToken = (JwtAuthenticationToken) SecurityContextHolder.getContext()
				.getAuthentication();
		...
		try {
			if (jwt != null) {
				...
				oauthJwtToken.setDetails(userDetails); // this is a hack!!! - using setDetails(Object) to encapsulate
																								// userDetails
